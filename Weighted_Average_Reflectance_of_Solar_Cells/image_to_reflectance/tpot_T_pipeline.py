...
# Average CV score on the training set was: -4.32363391379459
exported_pipeline = RandomForestRegressor(bootstrap=True, max_features=1.0, min_samples_leaf=1, min_samples_split=9, n_estimators=100)
